...
from tiger.modeling.dataloader.base import TorchDataloader
from tiger.modeling.dataloader.batch_processors import BasicBatchProcessor
from tiger.modeling.dataset.base import ScientificDataset
from tiger.modeling.loss import SASRecLoss, CompositeLoss
from tiger.modeling.metric.base import NDCGMetric, RecallMetric, CoverageMetric
from tiger.modeling.models import SasRecModel
...
def main():
    ...
    model = SasRecModel.create_from_config(config['model'], **dataset.meta).to(DEVICE)
